			...
			link: function(scope, element, attrs) {
				...
				var smartActions = {
				    ...
				    userLogout: function($this){
						...
						$.SmartMessageBox({
							...
							if (ButtonPressed == "Yes") {
								 $.rootElement.addClass('animated fadeOutUp');
				    ...
				    launchFullscreen: function(element){
						...
						if (! $.rootElement.hasClass("full-screen")) {
					
							 $.rootElement.addClass("full-screen");
							...
							if (element.requestFullscreen) {
							 ...
							 $.rootElement.removeClass("full-screen");
				   ...
				   // MINIFY MENU
				    minifyMenu: function($this){
				    	if (! $.rootElement.hasClass("menu-on-top")){
							$.rootElement.toggleClass("minified");
							$.rootElement.removeClass("hidden-menu");
				    ...
				    toggleMenu: function(){
				    	if (! $.rootElement.hasClass("menu-on-top")){
							$('html').toggleClass("hidden-menu-mobile-lock");
							 $.rootElement.toggleClass("hidden-menu");
							 $.rootElement.removeClass("minified");
				    	} else if (  $.rootElement.hasClass("menu-on-top") &&  $.rootElement.hasClass("mobile-view-activated") ) {
				    		$('html').toggleClass("hidden-menu-mobile-lock");
							 $.rootElement.toggleClass("hidden-menu");
							 $.rootElement.removeClass("minified");
				    	}
				    ...
				    toggleShortcut: function(){
						...
						function shortcut_buttons_hide() {
							shortcut_dropdown.animate({
							 ...
							 $.rootElement.removeClass('shortcut-on');
						...
						function shortcut_buttons_show() {
							shortcut_dropdown.animate({
							 ...
							 $.rootElement.addClass('shortcut-on');
						}
		...
		return {
			...
			link: function(scope, element, attrs) {
				...
				angular.element('#search-mobile').click(function() {
					 $.rootElement.addClass('search-mobile');
				});

				angular.element('#cancel-search-js').click(function() {
					 $.rootElement.removeClass('search-mobile');
				});
			}
		};
	})
			...
			link: function(scope, element, attrs) {
				...
				$('input[type="checkbox"]#smart-fixed-header')
				    .click(function () {
				        if ($(this)
				            .is(':checked')) {
				            //checked
				             $.rootElement.addClass("fixed-header");
				        } else {
				            //unchecked
				            ...
				            $('input[type="checkbox"]#smart-fixed-navigation')
				             ...
				             $.rootElement.removeClass("fixed-header");
				             $.rootElement.removeClass("fixed-navigation");
				             $.rootElement.removeClass("fixed-ribbon");
				    ...
				    .click(function () {
				        if ($(this)
				            ...
				            $('input[type="checkbox"]#smart-fixed-header')
				             ...
				             $.rootElement.addClass("fixed-header");
				             $.rootElement.addClass("fixed-navigation");

				            $('input[type="checkbox"]#smart-fixed-container')
				                .prop('checked', false);
				             $.rootElement.removeClass("container");
				    ...
				    .click(function () {
				        if ($(this)
				            ...
				            //apply
				             $.rootElement.addClass("fixed-header");
				             $.rootElement.addClass("fixed-navigation");
				             $.rootElement.addClass("fixed-ribbon");
				...
				$('input[type="checkbox"]#smart-fixed-footer')
				    .click(function () {
				        if ($(this)
				            ...
				            //checked
				             $.rootElement.addClass("fixed-page-footer");

				        } else {
				            //unchecked
				             $.rootElement.removeClass("fixed-page-footer");
				        }
				    });
				...
				$('input[type="checkbox"]#smart-rtl')
				    .click(function () {
				        if ($(this)
				            ...
				            //checked
				             $.rootElement.addClass("smart-rtl");

				        } else {
				            //unchecked
				             $.rootElement.removeClass("smart-rtl");
				        }
				    });
				...
				$("#smart-styles > a")
				   .on('click', function() {
				        var $this = $(this);
				        var $logo = $("#logo img");
				         $.rootElement.removeClassPrefix('smart-style')
		...
		return {
			...
			link: function(scope, element, attrs, parentCtrls) {
	    		...
	    		element.on('click', 'a[href!="#"]', function() {
	    			if ($.rootElement.hasClass('mobile-view-activated')) {
	    				 $.rootElement.removeClass('hidden-menu');
	    				$('html').removeClass("hidden-menu-mobile-lock");
	    			}
	    		});
